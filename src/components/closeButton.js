...
class CloseButton extends React.Component
{
    ...
    render()
    {
        let classString = `rounded btn btn-outline-secondary mb-2 mr-sm-2 rouded-circle ${this.props.className}`;
            return (
                <button className={classString} name={this.props.name} onClick={()=>this.props.handler(this.props.name)}>
